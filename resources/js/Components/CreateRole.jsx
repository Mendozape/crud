...
export default function CreateRole() {
    ...
    // 🚨 New state to track the "Select All" checkbox status
    ...
    // 🚨 Logic to update the "Select All" checkbox state when individual permissions change
    useEffect(() => {
        // Only run if permissions data has loaded
    ...
    // 🚨 New function to handle the "Select All" checkbox change
    ...
    const handleSubmit = async (e) => {
        ...
        if (!name.trim()) {
            setNameError("El nombre del role es obligatorio."); // Below the input
            setErrorMessage("Debe ingresar un nombre de role."); // Global
            return;
        }

        if (roles.some((r) => r.name.toLowerCase() === name.toLowerCase())) {
            setNameError("El nombre del role ya existe."); // Below the input
            setErrorMessage("El nombre del role ya existe."); // Global
            return;
        }
        ...
        try {
            ...
            setErrorMessage(err.response?.data?.message || "Error al crear el role.");
        }
    };
        ...
        <div className="row mb-4">
            <div className="col-md-8 offset-md-2">
                <div className="border rounded p-4 bg-white shadow-sm">
                    <h2 className="text-center mb-4 text-2xl font-bold">Crear Role</h2>
