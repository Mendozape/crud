...
            name: 'Acciones',
            cell: row => (
                // CLAVE: Usamos 'd-flex' para flexbox, 'gap-1' para espaciado mínimo, y 'whiteSpace: "nowrap"' para evitar saltos.
                <div className="d-flex gap-1 justify-content-end" style={{ whiteSpace: 'nowrap' }}>
                    <button className="btn btn-primary btn-sm" onClick={() => createPayment(row.id)}>Pagos</button>
...
                </div>
            ),
            // Aseguramos un ancho suficiente
            minWidth: '200px',
        },
    ];
